    ...
    return (
        ...
        <div className="PlantApp" style={{padding:'6rem'}}>
            ...
            <label>
                ...
                className={isFileSelected ? 'file-selected plant-button-like-selected' : 'plant-button-like'}
            /></label>
                

            {/* <br /> */}
            <button className="plant-fileupload-button" onClick={handleSubmit} disabled={isLoading}>
                Submit
            </button>
                ...
                {isLoading ? (
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <button className="plant-moredetails" onClick={handleMoreDetailsClick}>More Details</button>
                            <button className="plant-careguide" onClick={handleCareGuideClick}>Care-Guide</button>
                            <button className="plant-faq" onClick={handleFAQClick}>FAQ</button>
                            <br />
                        ...
                        {response.map((plant, index) => (
                            <li key={index} onClick={() => handlePlantItemClick(plant)} className="plant-item">
                                ...
                                <div className="plant-info">
                                    ...
                                    <br />
                                    <p><strong>Probability: </strong>{Math.round(plant.probability * 100)}%</p>
                                </div>
                            </li>
                        ))}
                    </ul>
            ...
            >
                ...
                <button className='close-more-details' onClick={closeMoreDetailsModal}>Close</button>
            </Modal>
