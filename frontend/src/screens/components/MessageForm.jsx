                            ...
                            {messagesByDate?.map(({ content, time, from: sender }, msgIdx) => (
                                <div className={sender?.email == user?.email ? "message" : "incoming-message"} key={msgIdx}>
                                    <div className="message-inner">
                                        ...
                                        <img src={dp} style={{ width: 35, height: 35, objectFit: "cover", borderRadius: "50%", marginRight: 10 }} />
            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col md={1} style={{padding : '0px'}}>
                        <Button variant="primary" type="submit" style={{ width: "100%", backgroundColor: "white"}} disabled={!user}>
                        <img src={sendicon} height='25rem' width='25rem'/>    
                        </Button>
                    </Col>
                </Row>
            </Form>
