const Plant = require('../models/workoutModel');
const mongoose = require('mongoose');
const { getaccessToken, getPlantDetailsMiddleware, fetchPlant, fetchPlantdetails, fetchcareGuide , fetchFAQdetails} = require('../middleware/plantMiddleware');
...
module.exports = { getPlant, searchPlant, fetchcareGuidedetails, fetchFAQ };