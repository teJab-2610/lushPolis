        ...
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="#">
              <img className="footer-logo-image" src={logo} width="150px" height="50px" alt="Logo" />
            </a>
          </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2023. | Designed By: Team Lushpolis. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
